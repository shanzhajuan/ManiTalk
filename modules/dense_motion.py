...
class DenseMotionNetwork(nn.Module):
    ...
    def __init__(self, block_expansion, num_blocks, max_features, num_tps, tps_num_points, num_channels, 
        ...
        self.scale_factor = scale_factor # 0.25
        self.multi_mask = multi_mask # true

        self.hourglass = Hourglass(block_expansion=block_expansion, in_features=(num_channels * (num_tps+1) + num_tps*tps_num_points+1), 
        ...
        self.tps_num_points = tps_num_points
        self.bg = bg # true
    ...
    def create_transformations(self, source_image, kp_driving, kp_source, bg_param):
        ...
        kp_1 = kp_1.view(bs, self.num_tps, self.tps_num_points, -1)
        kp_2 = kp_2.view(bs, self.num_tps, self.tps_num_points, -1)
