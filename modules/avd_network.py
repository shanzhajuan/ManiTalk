...
class AVDNetwork(nn.Module):
    ...
    def __init__(self, num_tps, id_bottle_size=64, pose_bottle_size=64):  # 10，128,128
    ...
    def forward(self, kp_source, kp_random):
        ...
        pose_emb = self.pose_encoder(kp_random['fg_kp'].view(bs, -1)) #bs,128
        id_emb = self.id_encoder(kp_source['fg_kp'].view(bs, -1)) #bs,128
